...
## 2024-05-30 - 入力UIのコンテキスト明示
**学び:** showInputBox や showQuickPick に title を指定しないと、どの拡張機能からの要求か不明瞭になりユーザーの不安を煽る。
**アクション:** ユーザー入力を求めるネイティブUIには必ず title を設定し、コンテキストを明示する。
