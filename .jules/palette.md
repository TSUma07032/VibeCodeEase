...
## 2024-09-09 - Hello Worldポップアップのステータスバーへの変更
**学び:** showInformationMessageはユーザーの作業を中断させるため、単なる挨拶や通知には不適切である。ステータスバーメッセージを利用することで、非侵入型のフィードバックが可能になる。
**アクション:** ユーザーの明示的な確認が必要ない通知には、常にsetStatusBarMessageをタイムアウト付きで使用する。
