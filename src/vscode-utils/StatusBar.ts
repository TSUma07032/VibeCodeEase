    ...
    public updateState() {
        ...
        switch (preset) {
            case 'LEARNING': {
                ...
                const md = new vscode.MarkdownString('**vibeCodeEase:** 学習モード (解説ヒント中心)\n\n*クリックで動作モードを変更*');
            ...
            case 'FLOW': {
                ...
                const md = new vscode.MarkdownString('**vibeCodeEase:** フローモード (自動修正中心)\n\n*クリックで動作モードを変更*');
                md.supportThemeIcons = true;
                this.statusBarItem.tooltip = md;
                break;
            }
            case 'ZEN': {
                ...
                const md = new vscode.MarkdownString('**vibeCodeEase:** 職人モード (介入最小)\n\n*クリックで動作モードを変更*');
                md.supportThemeIcons = true;
                this.statusBarItem.tooltip = md;
                break;
            }
            case 'CUSTOM': {
                ...
                const md = new vscode.MarkdownString(`**vibeCodeEase:** カスタム設定\n\n${details}\n\n*クリックで動作モードを変更*`);
                md.supportThemeIcons = true;
                this.statusBarItem.tooltip = md;
                break;
            }
